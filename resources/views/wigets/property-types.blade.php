...
<script>
    $(document).ready(function () {
        ...
        $("#table_list_2").jqGrid({
            ...
            rowNum: 20,
            rowList: [10, 20, 30],
            colNames:['ID','Type','Created on', 'Updated on'],
            colModel:[
                {name: 'id', index: 'id', width: 60, sorttype: "int",sortable: true},
                {name:'type',index:'type', editable: true, width:100,sortable: true},
