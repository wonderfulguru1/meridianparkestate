                ...
                <div class="col-lg-4">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <span class="label label-primary pull-right">View them</span>
                            <h5>Total Users</h5>
                        </div>
                        <div class="ibox-content">
                            <h1 class="no-margins">{{count($users)}}</h1>
                            <small>All time users</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <span class="label label-info pull-right">view them</span>
                            <h5>New Customers</h5>
                        </div>
                        <div class="ibox-content">
                            <h1 class="no-margins">{{count($customers)}}</h1>
                            <small>Customers from  newsletters and forms</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <span class="label label-warning pull-right">view them</span>
                            <h5>Total properties </h5>
                        </div>
                        <div class="ibox-content">
                            <h1 class="no-margins">{{count($properties)}}</h1>
                            <small>All created properties</small>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label class="control-label" for="quantity">Mobile</label>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="control-label" for="status">Created On</label>
