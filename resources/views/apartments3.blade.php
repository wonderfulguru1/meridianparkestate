                    ...
                    <div class="col-md-12 ">
                        ...
                        <div class="HorizontalTab HorizontalTab_2 tabs_hor_2">
                            ...
                            <ul class="resp-tabs-list hor_1">
                                <li class="tabs-1"><i class="fc_icons fa fa-user"></i> <span class="tabs-text">APARTMENTS</span></li>
                                <li class="tabs-2"><i class="fc_icons fa fa-tasks"></i>
                                    <span class="tabs-text">TERRACE</span></li>
                                <li class="tabs-3"><i class="fc_icons fa fa-briefcase"
                                    ></i> <span class="tabs-text">SEMI DETACHED</span></li>
                                <li class="tabs-4"><i class="fc_icons fa fa-bullhorn">
                            ...
                            <div class="resp-tabs-container hor_1">
                                ...
                                <div class="fc-tab-1">
                                    ...
                                    <h2 class="title_contanier">Apartments</h2>
